...
const Footer = () => {
  return (
    <footer className="w-full mt-16 mb-4 bg-secondary text-primary-foreground p-4 shadow-md">
      <div className="container">
        <div className="grid grid-cols-12 gap-8 py-6 lg:grid-cols-8">
          <div className="mb-0 col-span-full lg:col-span-2 ">
            ...
            <p className="py-8   lg:max-w-xs text-center lg:text-left">
              Trusted in more than 100 institutions & 5 million Customers.
          ...
          <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
            ...
            <ul className="  transition-all duration-500">
              <li className="mb-4">support@risanmart.com</li>
          ...
          <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:order-last sm:col-span-4 md:col-span-4 lg:order-none lg:col-span-2">
            ...
            <ul className=" transition-all duration-500  ">
              <li className="mb-4">
                <a href="javascript:;" className=" hover:text-gray-900">
          ...
          <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
            ...
            <div className="flex flex-col items-center lg:items-start">
              <input
                type="text"
                className="w-full h-12 border border-gray-300 rounded-full py-2.5 px-5 shadow-sm  mb-5 text-center lg:text-left placeholder:text-gray-400 focus:outline-none focus:border-primary"
        ...
        <div className="py-3 border-t border-primary">
          <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
            ...
            <ul className="flex items-center gap-9 mt-4 lg:mt-0">
              <li>
                <a href="javascript:;" className="text-sm ">
                  Terms
                </a>
              </li>
              <li>
